...
public class MainActivity extends AppCompatActivity implements View.OnTouchListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shift_Button = (Button)findViewById(R.id.shift);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        LinearLayout function_layout = (LinearLayout)findViewById(R.id.function_layout);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(moving){
                    ...
                    if(command == DrawView.DrawCommand.DRAW_RECT){
                        ...
                        rect.top = rect.top + distance_y;
                        rect.bottom = rect.bottom + distance_y;
                        rect.left = rect.left + distance_x;
                        rect.right = rect.right + distance_x;
                    ...
                    if(command == DrawView.DrawCommand.DRAW_OVAL){
                        ...
                        float distance_x = current_x - start_x;
                        float distance_y = current_y - start_y;
                        oval.rect.top = oval.rect.top + distance_y;
                        oval.rect.bottom = oval.rect.bottom + distance_y;
                        oval.rect.left = oval.rect.left + distance_x;
                        oval.rect.right = oval.rect.right + distance_x;
                    ...
                    if(command == DrawView.DrawCommand.DRAW_CIRCLE){
                        ...
                        float distance_x = current_x - start_x;
                        float distance_y = current_y - start_y;
                        circle.rect.top = circle.rect.top + distance_y;
                        circle.rect.bottom = circle.rect.bottom + distance_y;
                        circle.rect.left = circle.rect.left + distance_x;
                        circle.rect.right = circle.rect.right + distance_x;
                    ...
                    if(command == DrawView.DrawCommand.DRAW_ARC){
                        ...
                        float distance_x = current_x - start_x;
                        float distance_y = current_y - start_y;
                        arc.rect.top = arc.rect.top + distance_y;
                        arc.rect.bottom = arc.rect.bottom + distance_y;
                        arc.rect.left = arc.rect.left + distance_x;
                        arc.rect.right = arc.rect.right + distance_x;
